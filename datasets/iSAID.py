...
class_list = ["_background_", 'ship', 'stroage_tank', 'baseball_diamond', 'tennis_court', 'basketball_court', 'Ground_Track_Field', 'bridge', 'large_vehicle', 'small_vehicle', 'helicopter',
...
def load_cls_label_list(name_list_dir):
    label_dict = np.load(os.path.join(name_list_dir, 'isaid512.npy'), allow_pickle=True).item()
    modified_dict = {}
...
class iSAIDDataset(Dataset):
    def __init__(
        ...
        self.name_list_dir1 = os.path.join('/home/zhangyf/zhangyfcode/ATSG/datasets/iSAID/train.txt')
        self.name_list1 = load_img_name_list(self.name_list_dir1)
        self.obj_dir = os.path.join('/home/zhangyf/SAM/isaid512_obj_data')
        self.bod_dir = os.path.join('/home/zhangyf/SAM/isaid512_bod_data')
    ...
    def __getitem__(self, idx):
        ...
        img_name = os.path.join(str(self.img_dir), str(_img_name) + '.png')
