...
class vaiDataset(Dataset):
    def __init__(
        ...
        self.name_list_dir1 = os.path.join('/home/zhangyf/zhangyfcode/ATSG/datasets/vai/train.txt')
        self.name_list1 = load_img_name_list(self.name_list_dir1)
        self.obj_dir = os.path.join('/home/zhangyf/SAM/vai_obj_data')
        self.bod_dir = os.path.join('/home/zhangyf/SAM/vai_bod_data')
...
class vaiClsDataset(vaiDataset):
    def __init__(self,
                 root_dir=None,
                 name_list_dir=None,
                 split='train',
...
class vaiSegDataset(vaiDataset):
    def __init__(self,
                 root_dir=None,
                 name_list_dir=None,
                 split='train',
