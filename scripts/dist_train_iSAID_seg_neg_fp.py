...
parser.add_argument("--data_folder", default='/home/zhangyf/isaid512', type=str, help="dataset folder")
parser.add_argument("--list_folder", default='/home/zhangyf/zhangyfcode/ATSG/datasets/iSAID', type=str, help="train/val/test list file")
...
parser.add_argument("--w_obj", default=0.03, type=float, help="w_obj")
...
def validate(model=None, data_loader=None, args=None):
    ...
    cam_score = evaluate.scores(gts, cams,16)
    cam_aux_score = evaluate.scores(gts, cams_aux,16)
    model.train()

    tab_results, mIoU = format_tabs([cam_score, cam_aux_score, seg_score], name_list=["CAM", "aux_CAM", "Seg_Pred"], cat_list=iSAID.class_list)
