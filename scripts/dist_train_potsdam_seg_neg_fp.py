...
parser.add_argument("--data_folder", default='/home/zhangyf/potsdamlx', type=str, help="dataset folder")
parser.add_argument("--list_folder", default='/home/zhangyf/zhangyfcode/ATSG/datasets/potsdam', type=str, help="train/val/test list file")
...
parser.add_argument("--log_iters", default=1000, type=int, help=" logging iters")
...
def train(args=None):
    ...
    optim = getattr(optimizer, args.optimizer)(
        params=[
            {
                "params": param_groups[0],  #backbone
                "lr": args.lr,
                "weight_decay": args.wt_decay,
            },
            {
                "params": param_groups[1],  #backbone norm
                "lr": args.lr,
                "weight_decay": args.wt_decay,
            },
            {
                "params": param_groups[2],   # cls head
                "lr": args.lr * 8,
                "weight_decay": args.wt_decay,
            },
            {
                "params": param_groups[3],  #seg head
                "lr": args.lr * 8,
                "weight_decay": args.wt_decay,
            },
        ],
    ...
    for n_iter in range(args.max_iters):
        ...
        dino_map=dino_head(inputs) # 2 256 20 20
       ...
       # if (n_iter + 1) >= 4000 and (n_iter + 1) % 200 == 0:   
